"use strict";(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[301],{6389:function(e,t,n){n.d(t,{Bt:function(){return sT},ET:function(){return s_},IO:function(){return sn},JU:function(){return iL},PL:function(){return sv},QT:function(){return sg},Xo:function(){return so},ad:function(){return iO},ar:function(){return si},hJ:function(){return ix},r7:function(){return sw}});var r,i,s,a,o=n(9451),l=n(2890),u=n(824),h=n(340),c=n(5504),d=n(8701);n(3875);var f=n(5056).Buffer;let m="@firebase/firestore";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function(e){if("L"===e.limitType&&0===e.explicitOrderBy.length)throw new A(C.UNIMPLEMENTED,"limitToLast() queries require specifying at least one orderBy() clause")}(e._query),(function(e,t,n={}){let r=new S;return e.asyncQueue.enqueueAndForget(async()=>(function(e,t,n,r,i){let s=new id({next:n=>{s.Za(),t.enqueueAndForget(()=>rq(e,a)),n.fromCache&&"server"===r.source?i.reject(new A(C.UNAVAILABLE,'Failed to get documents from server. (However, these documents may exist in the local cache. Run again without setting source to "server" to retrieve the cached documents.)')):i.resolve(n)},error:e=>i.reject(e)}),a=new rK(n,s,{includeMetadataChanges:!0,_a:!0});return rU(e,a)})(await iw(e),e.asyncQueue,t,n,r)),r.promise})(n,e._query).then(n=>new sp(t,r,e,n)))}function sw(e,t,n,...r){e=iS(e,iD);let i=iS(e.firestore,iM),s=iH(i);return sE(i,[("string"==typeof(t=(0,h.m9)(t))||t instanceof iU?function(e,t,n,r,i,s){let a=e.Qu(1,t,n),o=[i2(t,r,n)],l=[i];if(s.length%2!=0)throw new A(C.INVALID_ARGUMENT,`Function ${t}() needs to be called with an even number of arguments that alternate between field names and values.`);for(let e=0;e<s.length;e+=2)o.push(i2(t,s[e])),l.push(s[e+1]);let u=[],c=eO.empty();for(let e=o.length-1;e>=0;--e)if(!i8(u,o[e])){let t=o[e],n=l[e];n=(0,h.m9)(n);let r=a.Nu(t);if(n instanceof iY)u.push(t);else{let e=iJ(n,r);null!=e&&(u.push(t),c.set(t,e))}}return new iQ(c,new eo(u),a.fieldTransforms)}(s,"updateDoc",e._key,t,n,r):function(e,t,n,r){let i=e.Qu(1,t,n);i1("Data must be an object, but it was:",i,r);let s=[],a=eO.empty();return ee(r,(e,r)=>{let o=i3(t,e,n);r=(0,h.m9)(r);let l=i.Nu(o);if(r instanceof iY)s.push(o);else{let e=iJ(r,l);null!=e&&(s.push(o),a.set(o,e))}}),new iQ(a,new eo(s),i.fieldTransforms)}(s,"updateDoc",e._key,t)).toMutation(e._key,tx.exists(!0))])}function s_(e,t){var n;let r=iS(e.firestore,iM),i=iL(e),s=(n=e.converter)?n.toFirestore(t):t;return sE(r,[(function(e,t,n,r,i,s={}){let a,o;let l=e.Qu(s.merge||s.mergeFields?2:0,t,n,i);i1("Data must be an object, but it was:",l,r);let u=iZ(r,l);if(s.merge)a=new eo(l.fieldMask),o=l.fieldTransforms;else if(s.mergeFields){let e=[];for(let r of s.mergeFields){let i=i2(t,r,n);if(!l.contains(i))throw new A(C.INVALID_ARGUMENT,`Field '${i}' is specified in your field mask but missing from your input data.`);i8(e,i)||e.push(i)}a=new eo(e),o=l.fieldTransforms.filter(e=>a.covers(e.field))}else a=null,o=l.fieldTransforms;return new iK(new eO(u),a,o)})(iH(e.firestore),"addDoc",i._key,s,null!==e.converter,{}).toMutation(i._key,tx.exists(!1))]).then(()=>i)}function sE(e,t){return function(e,t){let n=new S;return e.asyncQueue.enqueueAndForget(async()=>r4(await iv(e).then(e=>e.syncEngine),t,n)),n.promise}(iF(e),t)}function sT(){return new iX("serverTimestamp")}new WeakMap,function(e=!0){g=o.Jn,(0,o.Xd)(new l.wA("firestore",(t,{instanceIdentifier:n,options:r})=>{let i=t.getProvider("app").getImmediate(),s=new iM(new D(t.getProvider("auth-internal")),new V(t.getProvider("app-check-internal")),function(e,t){if(!Object.prototype.hasOwnProperty.apply(e.options,["projectId"]))throw new A(C.INVALID_ARGUMENT,'"projectId" not provided in firebase.initializeApp.');return new ev(e.options.projectId,t)}(i,n),i);return r=Object.assign({useFetchStreams:e},r),s._setSettings(r),s},"PUBLIC").setMultipleInstances(!0)),(0,o.KN)(m,"4.7.3",void 0),(0,o.KN)(m,"4.7.3","esm2017")}()}}]);