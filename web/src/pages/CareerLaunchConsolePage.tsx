...
export function CareerLaunchConsolePage() {
  return (
    <main className="page-shell career-launch-shell">
      <section className="hero career-mirror-hero">
        <div className="eyebrow">URAI-Jobs Launch Console</div>
        <h1>V1 through V5, visible and gated.</h1>
        <p>
          This console tracks the autonomous URAI-Jobs launch arc while preserving the runtime/product boundary.
