export type InterviewPrepRoom = {
  id: string;
  opportunityId: string;
  focusAreas: string[];
  questions: string[];
  tone: "calm" | "confident" | "technical" | "story-driven";
};
...
export type CareerOffer = {
  ...
  autonomyFit: "low" | "medium" | "high";
  meetingLoad: "low" | "medium" | "high";
  growthFit: "low" | "medium" | "high";
  burnoutRisk: "low" | "medium" | "high";
};

export type SpatialCareerPortal = {
  id: string;
  opportunityId: string;
  label: string;
  routeType: "golden-path" | "shadow-repeat" | "future-self";
  fieldNotes: string[];
};

export const interviewPrepSeed: InterviewPrepRoom = {
...
export const careerOffersSeed: CareerOffer[] = [
  {
    id: "offer-ai-builder",
...
export const spatialCareerPortalSeed: SpatialCareerPortal = {
  id: "portal-v4-seed",
...
export function compareOffers(offers: CareerOffer[]) {
  return offers.map((offer) => ({
    ...offer,
    decisionScore:
      (offer.autonomyFit === "high" ? 30 : offer.autonomyFit === "medium" ? 18 : 8) +
