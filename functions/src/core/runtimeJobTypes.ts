...
export const RUNTIME_JOB_REGISTRY: Record<ActiveRuntimeJobType, RuntimeJobDefinition> = {
  ...
  'web.search': {
    owner: 'urai-jobs',
    payloadContract: 'TinyFish SearchPayloadSchema',
    resultContract: 'Bounded TinyFish search result envelope',
    workerEnvKey: '',
    route: '',
    mode: 'sync',
    timeoutMs: 60000,
    ...
    cancellation: 'lease-fenced',
    providerCostClass: 'provider-bound',
    artifactContract: 'bounded retrieval result + Jobs audit receipt',
  },
  'web.fetch': {
    owner: 'urai-jobs',
    payloadContract: 'TinyFish FetchPayloadSchema',
    resultContract: 'Bounded TinyFish fetch result envelope',
    workerEnvKey: '',
    route: '',
    mode: 'sync',
    timeoutMs: 60000,
  ...
  'web.agent': {
    owner: 'urai-jobs',
    payloadContract: 'TinyFish AgentPayloadSchema + explicit paid-run authorization',
    resultContract: 'Bounded TinyFish agent result envelope',
    workerEnvKey: '',
    route: '',
    mode: 'sync',
    timeoutMs: 300000,
    ...
    cancellation: 'lease-fenced',
    providerCostClass: 'external-provider-hard-off',
    artifactContract: 'bounded agent result + explicit authorization/audit receipt',
  },
};
