...
for (const [path, text, label] of [
  ...
  ['scripts/deploy-firebase.sh', 'COMMUNICATIONS_WORKER_URL=$COMMUNICATIONS_WORKER_URL', 'Communications worker binding'],
  ['scripts/deploy-firebase.sh', 'PRIVATE_SOURCE_WORKER_URL=$PRIVATE_SOURCE_WORKER_URL', 'private-source worker binding'],
  ['scripts/deploy-firebase.sh', 'communicationsWorkerUrl: process.env.COMMUNICATIONS_WORKER_URL', 'Communications worker receipt'],
  ['scripts/deploy-firebase.sh', 'privateSourceWorkerUrl: process.env.PRIVATE_SOURCE_WORKER_URL', 'private-source worker receipt'],
  ['.github/workflows/urai-jobs-production-deploy.yml', 'CONFIG_COMMUNICATIONS_WORKER_URL: ${{ vars.COMMUNICATIONS_WORKER_URL }}', 'protected Communications origin'],
  ['.github/workflows/urai-jobs-production-deploy.yml', 'CONFIG_PRIVATE_SOURCE_WORKER_URL: ${{ vars.PRIVATE_SOURCE_WORKER_URL }}', 'protected private-source origin'],
