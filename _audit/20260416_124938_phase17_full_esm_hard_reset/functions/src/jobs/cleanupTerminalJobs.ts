import { Job, JobQueueEntry, UserRole, JobLog, NarratorTtsPayloadSchema } from '../shared-types.js.js.js';
...
import { JOBS_COLLECTION, jobQueueEntryDoc } from '../core/firestore-paths.js.js.js';
